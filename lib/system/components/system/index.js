...
function System() {
	...
	_this.initialize = function($happn, callback){
		...
		url = "http://"+address.address+":"+address.port+"/system/dashboard";
	...
	_this.getDBFileInfo = function($happn, callback){
		...
		if ($happn.data.context.services.data.config && $happn.data.context.services.data.config.dbfile)
			fs.stat($happn.data.context.services.data.config.dbfile, function(e, filestats){
			
				if (e) return callback(e);

				$happn.data.context.services.data.config.dbfile

				filestats.filename = $happn.data.context.services.data.config.dbfile;
